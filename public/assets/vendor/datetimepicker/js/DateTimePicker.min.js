...
$.data(this,"plugin_DateTimePicker",new DateTimePicker(this,options))})}};DateTimePicker.prototype={init:function(){var oDTP=this;oDTP._setDateFormatArray();oDTP._setTimeFormatArray();oDTP._setDateTimeFormatArray();if($(oDTP.element).data('parentelement')!==undefined){oDTP.settings.parentElement=$(oDTP.element).data('parentelement')}
